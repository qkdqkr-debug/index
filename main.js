...
const translations = {
    ...
    "ko": {
        ...
        "post_mental_wellness_excerpt": "디지털 시대는 정신 건강에 독특한 도전을 제시합니다. 끊임없는 알림, 소셜 미디어 압력 속에서 균형 잡힌 삶을 탐색하고 가꾸는 전략을 발견하십시오.",
        "post_crypto_blockchain_title": "암호화폐와 블록체인 이해하기: 과대광고를 넘어서",
        "post_crypto_blockchain_excerpt": "암호화폐 뒤에 숨겨진 기반 기술을 깊이 파고들어 보십시오. 분산 원장으로서의 블록체인과 금융, 물류 등을 재편할 수 있는 잠재력을 투기성 헤드라인을 넘어 알아보세요.",
        "post_5g_impact_title": "5G 기술이 우리 일상생활에 미치는 영향",
        "post_5g_impact_excerpt": "5G의 엄청난 속도와 초저지연이 스마트 도시에서 헬스케어에 이르기까지 산업을 어떻게 변화시키고 있는지 탐구하십시오. 사물 인터넷(IoT)의 잠재력을 최대한 발휘하는 데 있어 5G의 역할을 이해하십시오.",
