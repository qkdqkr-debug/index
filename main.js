...
const translations = {
    "ko": {
        ...
        "about_paragraph2": In a complex and rapidly changing world, accurate self-knowledge is crucial. Our site goes beyond simply providing test results, offering in-depth interpretations and practical advice for each personality type and intelligence domain. We aim to help users understand themselves and communicate effectively with others. All content is meticulously designed based on advice from psychological experts and the latest research to ensure reliability and accuracy.",
